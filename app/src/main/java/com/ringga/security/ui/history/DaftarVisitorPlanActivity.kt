...
import kotlinx.android.synthetic.main.activity_daftar_visitor_plan.*
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class DaftarVisitorPlanActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_daftar_visitor_plan)
        ...
        RetrofitClient.instance.list_visitor(PreferencesToken.getToken(this)!!, myProfile?.id.toString(),"plan")
            .enqueue(object : Callback<VisitorRespon> {
                ...
                override fun onFailure(call: Call<VisitorRespon>, t: Throwable) {
                    Toast.makeText(this@DaftarVisitorPlanActivity, t.message, Toast.LENGTH_SHORT).show()
                    loading.visibility = View.GONE
                }
    ...
    private fun setupRecler() {
        rv_daftarvisitor.apply {
            ...
            adapter = VisitorAdapter(mutableListOf(), this@DaftarVisitorPlanActivity)
        }
    }
}